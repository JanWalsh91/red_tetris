...
import {updateHostList, updateGameJoined, updateGameState, updateShadowState, updateHostStatus, updatePlayerUUID} from './actions/client'
...
socket.on(ActionNames.UPDATE_GAME_STATE, (gameState) => {
	console.log("[socket.js] UPDATE_GAME_STATE: ", gameState);
